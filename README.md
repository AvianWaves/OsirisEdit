...
Modbap created a browser/js version of the editor to replace their fork of WaveEdit which was only built for Mac/Linux.  It works, but I prefer the GUI of the original version.  And I like having the EXE file just on my PC rather than the whole brwowser/js stack.  They had a work-in-progress Windows verison but I couldn't get it to compile as it was.  I forked that, updated some libraries, and did some tweaking until I got it to compile and work.  Really, 99% of the effort was Modbap.  But this does now compile and run successfully on Windows.  I am including a build in a zip file so you don't have to compile it yourself, but the code is here if you want to.  
